  ...
  return (
    <Sidebar collapsible="icon" className="bg-transparent hover:bg-transparent">
      ...
      <SidebarContent className="p-0 flex flex-col">
        <div className="flex items-center justify-between px-5 pb-3 pt-5 shrink-0">
          ...
          <div className="flex flex-col items-end gap-2">
            <Button
              size="sm"
              variant="secondary"
              className="rounded-full bg-card shadow-lg text-black dark:text-white"
        ...
        <div className="mx-5 mb-3 h-px bg-border shrink-0" />
            ...
            <ul className="space-y-1.5">
              {sessions.map((session) => (
                <li key={session._id}>
                  <div
                    className={cn(
                      "flex items-center gap-1 rounded-xl border px-2 py-1 transition-all duration-200",
                  ...
                  >
                    <button
                      ...
                      className="flex flex-1 flex-col gap-1 rounded-lg px-2 py-2 text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-ring"
