          ...
          {[
            {
              ...
              category:
                "Auto-sync your entire conversation history with MongoDB",
              year: "Live",
              direction: "left",
            },
            {
              ...
              category:
                "Rename or delete threads without breaking streaming replies",
              year: "Live",
              direction: "right",
            },
            {
              ...
              category:
                "Surface tokens, duration, key provenance, and source counts instantly",
              year: "New",
              direction: "left",
            },
          ].map((project, i) => (
...
function ProjectCard({
  ...
  return (
    <div
      className={`group flex items-center justify-between border-foreground/10 border-b py-6 transition-all duration-700 hover:border-foreground/20 md:py-8 ${getRevealClass()} ${delayClass} ${sizeClass}`}
    >
      <div className="flex items-baseline gap-4 md:gap-8">
        ...
        <div>
          <h3 className="mb-1 font-light font-sans text-2xl text-foreground transition-transform duration-300 group-hover:translate-x-2 md:text-3xl lg:text-4xl">
            {project.title}
          </h3>
